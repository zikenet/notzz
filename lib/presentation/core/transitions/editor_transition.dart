...
class EditorTransition extends StatefulWidget {
  ...
  @override
  State<EditorTransition> createState() => _EditorTransitionState();
}

class _EditorTransitionState extends State<EditorTransition> {
